...
var file_sync_trie_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x42, 0x28, 0x5a, 0x26, 0x67,
...
var file_sync_trie_proto_goTypes = []interface{}{
...
func file_sync_trie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sync_trie_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
